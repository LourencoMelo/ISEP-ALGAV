...
% a)
potencia(A,0,1):- A=\=0.
potencia(B,E,R):- (E>=0, E1 is E-1, potencia(B,E1,R1), R is B*R1); (E<0, E2 is E*(-1), potencia(B,E2,R1), R is 1/R1).
...
% c)
somatorio(N,N,N).
somatorio(N1,N2,Sum):- (N1< N2, N is N1+1, somatorio(N,N2, SumInt), Sum is SumInt + N1).

% d)
% com recursividade
divisao(N1,N2,0,N1):- N1 < N2.
divisao(N1,N2,Q,R):- Dif is N1-N2, divisao(Dif,N2,Q1,R),  Q is Q1 + 1.

% Sem recursividade
divisaoSem(N1,N2,Q,R):- Q is N1//N2, R is N1 mod N2.